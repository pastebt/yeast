...
class TestWhere(unittest.TestCase):
    ...
    def test_and1(self):
        ...
        self.assertEqual(w.sql(db), "((`uid` > 1 and col2 >  1) and `name` = 'a')")
    ...
    def test_or1(self):
        ...
        self.assertEqual(w.sql(db), "((`uid` > 1 or col2 >  1) or `name` = 'a')")
...
class TestSQL(unittest.TestCase):
    def test_select_sql1(self):
        ...
        self.assertEqual(s, "select `uid`, `pass`, `name` from t1 where `uid` > 0")
    ...
    def test_insert_sql1(self):
        ...
        self.assertEqual(s, "insert into t1 (`uid`, `pass`, `name`) values (1, 'p', 'n')")
        t2 = T2(pwd="p")
